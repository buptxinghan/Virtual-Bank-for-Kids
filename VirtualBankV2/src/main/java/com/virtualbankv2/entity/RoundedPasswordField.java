...
/**
 * The RoundedPasswordField class extends JPasswordField and is part of the entity package of the VirtualBankV2 application.
 * It is responsible for creating a password field with rounded corners.
 *
 * @author Botong Wu
 * @version 1.0
 * @since 2024-04-12
...
public class RoundedPasswordField extends JPasswordField {
    private Shape shape;
    /**
     * Constructor for the RoundedPasswordField.
     * Initializes the text field with the given size and sets it to be non-opaque.
     *
     * @param size The size of the password field.
     */
