...
public class CreateTaskPage extends JFrame{
    ...
    private void initializeComponents() {
        ...
        JDateChooser chooseStart = new JDateChooser();
        chooseStart.setDateFormatString("yyyy-MM-dd HH:mm");
        //Date start = chooseStart.getDate();
        //String strDate = new SimpleDateFormat("yyyy-MM-dd HH:mm").format(date);
        JDateChooser chooseEnd = new JDateChooser();
        chooseEnd.setDateFormatString("yyyy-MM-dd HH:mm");
